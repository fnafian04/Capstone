...
@section('styles')
    <style>
        ...
        * {
        ...
        @keyframes pulseSoft {
            0% {
                box-shadow: 0 0 0 0 rgba(61, 106, 255, 0.6);
            }

            70% {
                box-shadow: 0 0 0 14px rgba(61, 106, 255, 0);
            }
    ...
    <div class="container py-4 pb-5 mb-5">
        ...
        <div class="container mb-4">
            <div class="input-group shadow-sm">
                ...
                <input type="text" id="search-input" class="form-control" placeholder="Cari menu atau nama toko..."
                    oninput="searchMenu()">
            </div>
        </div>
            ...
            <div class="modal-content border-0 shadow-lg overflow-hidden">
                ...
                <div class="modal-body p-0">
                    ...
                    <div class="p-4">
                        ...
                        <div class="row g-2">
                            <div class="col-6">
                                <button class="btn btn-outline-primary w-100" onclick="addDetailToCart()">+
                                    Keranjang</button>
                            </div>
                            <div class="col-6">
