    ...
    <d id="wrapper">
        <div id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush mt-2">
                <a class="list-group-item active" onclick="showSection('dashboard', this)"><i
                        class="fas fa-tachometer-alt"></i> Dashboard</a>
                <a class="list-group-item" onclick="showSection('pending', this)"><i class="fas fa-clock"></i> Pesanan
                    Pending</a>
                ...
                <a class="list-group-item" onclick="showSection('kasir', this)"><i class="fas fa-users-cog"></i> Manajemen
                    Kasir</a>
                <a class="list-group-item" onclick="showSection('menu', this)"><i class="fas fa-utensils"></i> Kelola
                    Menu</a>
                <a class="list-group-item text-danger mt-5" href="#" onclick="logout()"><i
        ...
        <div id="page-content-wrapper">
            ...
            <div id="dashboard" class="section-content active">
                ...
                <div class="row g-4">
                    ...
                    <!-- KIRI: TOTAL TOKO + TOTAL MENU -->
                    <div class="col-md-5">
                        <div class="row g-4">
                            <div class="col-12">
                                <div class="card card-custom bg-primary text-white p-4 position-relative overflow-hidden">
                                    <div class="position-relative z-1">
                                        <h5 class="fw-light">Total Toko</h5>
                                        <h1 class="display-4 fw-bold mb-0" id="count-toko">0</h1>
                                    </div>
                                    <i class="fas fa-store position-absolute"
                                        style="font-size: 7rem; right: -15px; bottom: -15px; opacity: 0.2;"></i>
                                </div>
                            </div>

                            <div class="col-12">
                                <div class="card card-custom bg-success text-white p-4 position-relative overflow-hidden">
                                    <div class="position-relative z-1">
                                        <h5 class="fw-light">Total Menu</h5>
                                        <h1 class="display-4 fw-bold mb-0" id="count-menu">0</h1>
                                    </div>
                                    <i class="fas fa-utensils position-absolute"
                                        style="font-size: 7rem; right: -15px; bottom: -15px; opacity: 0.2;"></i>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-7">
                        <div class="d-flex flex-column gap-4 h-100">
                            ...
                            <div class="card card-custom">
                                ...
                                <div class="card-body">
                                    <div id="dashboard-kasir" class="d-flex flex-column gap-3"></div>
                                </div>
                            </div>
            ...
            <div id="pending" class="section-content">
                <div class="card card-custom">
                    <div class="card-header-custom">
                        ...
                        <button class="btn btn-sm btn-outline-primary" onclick="loadPending()"><i
            ...
            <div id="riwayat" class="section-content">
                <div class="card card-custom">
                    <div class="card-header-custom">
                        ...
                        <button class="btn btn-sm btn-outline-primary" onclick="loadRiwayat()"><i
                                class="fas fa-sync-alt"></i></button>
                    </div>
                    <div class="card-body p-0">
                        <table class="table table-striped mb-0">
            ...
            <div id="toko" class="section-content">
                <div class="card card-custom">
                    <div class="card-header-custom">
                        ...
                        <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#tokoModal"
                            onclick="resetFormToko()">
            ...
            <div id="kasir" class="section-content">
                <div class="card card-custom">
                    <div
                        class="card-header-custom d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-light">
                        <h5 class="modal-title fw-bold">Form Toko</h5><button type="button" class="btn-close"
                            data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <input type="hidden" id="id-toko">
                        <div class="mb-3"><label class="form-label fw-bold">Nama Toko</label><input type="text"
                                id="nama-toko" class="form-control"></div>
                        <div class="mb-3"><label class="form-label fw-bold">Alamat</label>
                            <textarea id="alamat-toko" class="form-control" rows="2"></textarea>
                        </div>
                        <div class="mb-3"><label class="form-label fw-bold">No. Telepon (WA)</label><input
                                type="text" id="telp-toko" class="form-control"></div>
                        <div class="mb-3">
                    ...
                    <div class="modal-footer bg-light"><button type="button" class="btn btn-secondary"
                            ...
                            onclick="saveToko()">Simpan Data</button></div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="menuModal" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-light">
                        <h5 class="modal-title fw-bold" id="menu-modal-title">Form Menu</h5><button type="button"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3"><label class="form-label fw-bold">Pilih Toko</label><select
                                        id="id-toko-menu" class="form-select"></select></div>
                                <div class="mb-3"><label class="form-label fw-bold">Nama Menu</label><input
                                        type="text" id="nama-menu" class="form-control"></div>
                                <div class="mb-3"><label class="form-label fw-bold">Harga (Rp)</label><input
                                        type="number" id="harga-menu" class="form-control"></div>
                                <div class="mb-3"><label class="form-label fw-bold">Deskripsi</label>
                                    <textarea id="desc-menu" class="form-control" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                ...
                                <div id="container-foto-existing" style="display: none;">
                                    ...
                                    <div id="existing-photos"
                                        class="d-flex flex-wrap gap-2 mt-2 border p-2 rounded bg-light"
                    ...
                    <div class="modal-footer bg-light"><button type="button" class="btn btn-secondary"
                            data-bs-dismiss="modal">Batal</button><button type="button" class="btn btn-primary"
                            onclick="saveMenu()">Simpan Data</button></div>
                </div>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        <form id="formAddKasir">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="username-kasir" required
                                    placeholder="Contoh: kasir_pagi">
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-bold">Password</label>
                                <input type="text" class="form-control" id="password-kasir"
                                    placeholder="Kosongi jika tidak ingin mengubah password">
                                <small class="text-muted d-block mt-1" id="hint-password" style="display:none;">* Isi
                                    hanya
                                    jika ingin ganti password</small>
                            </div>
    ...
    @section('scripts')
        <script>
            ...
            async function loadPending() {
                ...
                try {
                    ...
                    let html = data.length ? '' :
                        '<tr><td colspan="5" class="text-center py-4 text-muted">Tidak ada pesanan pending</td></tr>';
                    data.forEach(o => {
                        html += `<tr>
            ...
            async function loadDashboardPending() {
                const tbody = document.getElementById('dashboard-pending');
                tbody.innerHTML = `<tr><td colspan="4" class="text-center py-3">Memuat...</td></tr>`;
                ...
                try {
                    ...
                    if (sliced.length === 0) {
                        tbody.innerHTML =
                            `<tr><td colspan="4" class="text-center text-muted py-4">Tidak ada pesanan pending</td></tr>`;
                        return;
                    }
                    ...
                    sliced.forEach(o => {
                        html += `
            <tr>
                <td>${new Date(o.waktu_pemesanan).toLocaleTimeString()}</td>
                <td>${o.no_meja}</td>
                <td>${o.nama_pelanggan}</td>
                <td class="text-end fw-bold">${formatRupiah(o.total_pembayaran)}</td>
            </tr>`;
                    ...
                    tbody.innerHTML = `<tr><td colspan="4" class="text-danger text-center">Gagal memuat</td></tr>`;
                }
            }

            async function loadDashboardKasir() {
                const container = document.getElementById('dashboard-kasir');
                container.innerHTML = 'Memuat...';

                try {
                    const res = await fetch(`${apiUrl}/admin/manajemen-kasir`, {
                        headers: {
                            'Authorization': `Bearer ${token}`
                        }
                    });
                    ...
                    if (data.length === 0) {
                        container.innerHTML = `<div class="text-muted">Belum ada kasir</div>`;
                        return;
                    }

                    let html = '';
                    data.forEach(k => {
                        const inisial = k.username.charAt(0).toUpperCase();
                        html += `
            <div class="card-kasir">
                ...
                <i class="fas fa-circle text-success"></i>
                    ...
                    container.innerHTML = `<div class="text-danger">Gagal memuat kasir</div>`;
                }
            }
            ...
            async function loadRiwayat() {
                ...
                try {
                    const res = await fetch(`${apiUrl}/admin/riwayat`, {
                        headers: {
                            'Authorization': `Bearer ${token}`
                        }
                    });
    ...
    <span class="badge-id badge-pesanan">
        ${formatInvoice(o.id_transaksi)}
            ...
            async function loadToko() {
                const res = await fetch(`${apiUrl}/admin/toko`, {
                    headers: {
                        'Authorization': `Bearer ${token}`
                    }
                });
        ...
        ${formatToko(t.id_toko)}
            ...
            function editToko(id, nama, alamat, telp, logoUrl) {
                ...
                if (logoUrl && logoUrl !== 'null') {
                    document.getElementById('preview-logo-toko').innerHTML =
                        `<img src="${logoUrl}" width="80" height="80" class="rounded-circle border shadow-sm" style="object-fit:cover;">`;
                }
            ...
            async function hapusToko(id) {
                if (confirm('Hapus toko ini?')) {
                    await fetch(`${apiUrl}/admin/toko/${id}`, {
                        method: 'DELETE',
                        headers: {
                            'Authorization': `Bearer ${token}`
                        }
            ...
            async function loadTokoDropdown() {
                ...
                data.forEach(t => {
                    filter.innerHTML +=
                        `<option value="${t.id_toko}">${formatToko(t.id_toko)} - ${t.nama_toko}</option>`;
                    select.innerHTML +=
                        `<option value="${t.id_toko}">${formatToko(t.id_toko)} - ${t.nama_toko}</option>`;
            ...
            async function loadMenu() {
                ...
                data.forEach(m => {
                    const foto = m.foto_url ?
                        `<img src="${m.foto_url}" width="50" height="50" class="rounded border" style="object-fit:cover;">` :
    ...
    <span class="badge-id badge-menu">
        ${formatMenu(m.id_menu)}
            ...
            async function editMenu(id) {
                resetFormMenu();
                try {
                    const res = await fetch(`${apiUrl}/admin/menu/${id}`, {
                        headers: {
                            'Authorization': `Bearer ${token}`
                        }
                    });
            ...
            async function deletePhoto(photoId, btnElement) {
                ...
                try {
                    const res = await fetch(`${apiUrl}/admin/menu/photo/${photoId}`, {
                        method: 'DELETE',
                        headers: {
                            'Authorization': `Bearer ${token}`
                        }
            ...
            async function saveMenu() {
                ...
                if (!tokoVal || !namaVal || !hargaVal) {
                    alert("Mohon lengkapi Nama Menu, Toko, dan Harga!");
                    return;
                }
                ...
                for (let i = 0; i < fileInput.files.length; i++) {
                    formData.append('foto_menu[]', fileInput.files[i]);
                }
            ...
            async function hapusMenu(id) {
                if (confirm('Hapus menu ini?')) {
                    await fetch(`${apiUrl}/admin/menu/${id}`, {
                        method: 'DELETE',
                        headers: {
                            'Authorization': `Bearer ${token}`
                        }
            ...
            async function loadKasir() {
                ...
                try {
                    ...
                    if (data.length === 0) {
                        container.innerHTML =
                            '<tr><td colspan="4" class="text-center py-4 text-muted">Belum ada akun kasir.</td></tr>';
                        return;
                    }
                    ...
                    data.forEach(user => {
                        ...
                        const avatarHtml =
                            `<div class="avatar-circle mx-auto" style="width:40px; height:40px; font-size:1rem;">${inisial}</div>`;
    ...
    <span class="badge-id badge-kasir">
        ${formatKasir(user.id)}
            ...
            async function hapusKasir(id) {
                ...
                try {
                    const res = await fetch(`${apiUrl}/admin/manajemen-kasir/${id}`, {
                        method: 'DELETE',
                        headers: {
                            'Authorization': `Bearer ${token}`
                        }
